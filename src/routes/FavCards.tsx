...
const [fav, setFav] = useState(false);
 ...
 const {cards, loading, error} = useCards();
  ...
  card.likes.includes(userId) && card.title.toLowerCase().includes(searchTerm.toLowerCase())
...
const { isLoggedIn } = useContext(AuthContext);
  return (
    <div className="flex justify-center flex-col  dark:bg-gray-400  ">
      <h1 className="md:text-6xl text-3xl font-serif p-4 text-blue-900 m-2 font-bold text-center dark:text-orange-500">Favorite Card</h1>
...
manage_search
    ...
    <div className="flex flex-row flex-wrap justify-center items-center p-20 countiner-cards">
      ...
      <div className="shadow-2xl p-0  mx-auto rounded-md my-6 text-center b-card dark:bg-orange-200">
        <Link
          to={`../cards/${c._id}`}
          key={c._id}
